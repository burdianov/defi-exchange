 ...
 * If the user is adding initial liquidity, user decides the ether and CD tokens he wants to add to the exchange. If he is adding the liquidity after the initial liquidity has already been added then we calculate the Crypto Dev tokens he can add, given the Eth he wants to add by keeping the ratios constant
 */
